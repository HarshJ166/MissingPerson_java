...
class Missing
	...
	public Missing()
	{
		...
		title = new JLabel("Missing person Form");
		...
		aadh = new JLabel("Aadhar number ");
		aadh.setFont(new Font("Arial", Font.PLAIN, 20));
		aadh.setSize(170, 20);
		aadh.setLocation(25, 400);
		c.add(aadh);

		taadh = new JTextField();
		taadh.setFont(new Font("Arial", Font.PLAIN, 15));
		taadh.setSize(190, 20);
		taadh.setLocation(200, 400);
		c.add(taadh);

		Ma = new JLabel("Mother's name");
		Ma.setFont(new Font("Arial", Font.PLAIN, 20));
		Ma.setSize(200, 20);
		Ma.setLocation(25, 450);
		c.add(Ma);

		tMa = new JTextField();
		tMa.setFont(new Font("Arial", Font.PLAIN, 15));
		tMa.setSize(190, 20);
		tMa.setLocation(200, 450);
		c.add(tMa);

		Fa = new JLabel("Father's name");
		Fa.setFont(new Font("Arial", Font.PLAIN, 20));
		Fa.setSize(200, 20);
		Fa.setLocation(25, 500);
		c.add(Fa);

		tFa = new JTextField();
		tFa.setFont(new Font("Arial", Font.PLAIN, 15));
		tFa.setSize(190, 20);
		tFa.setLocation(200, 500);
		c.add(tFa);

		ea = new JLabel("Email");
		ea.setFont(new Font("Arial", Font.PLAIN, 20));
		ea.setSize(350, 20);
		ea.setLocation(100, 550);
		c.add(ea);

		tea = new JTextField();
		tea.setFont(new Font("Arial", Font.PLAIN, 15));
		tea.setSize(190, 20);
		tea.setLocation(200, 550);
		c.add(tea);

		rp = new JLabel("Relation with person");
		rp.setFont(new Font("Arial", Font.PLAIN, 20));
		rp.setSize(350, 20);
		rp.setLocation(5, 600);
		c.add(rp);

		trp = new JTextField();
		trp.setFont(new Font("Arial", Font.PLAIN, 15));
		trp.setSize(190, 20);
		trp.setLocation(200, 600);
		c.add(trp);

		fol = new JLabel("Found at location");
